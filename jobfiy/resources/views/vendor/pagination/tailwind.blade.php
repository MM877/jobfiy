                    ...
                    @foreach ($elements as $element)
                        ...
                        @foreach ($element as $page => $url)
                                        @if ($page == $paginator->currentPage())
                                            ...
                                            <span class="px-3 py-1 mx-1 bg-gray-800 text-white rounded">
                                                {{ $page }}
                                            </span>
                                        @else
                                            {{-- Clickable Page Link --}}
                                            <a href="{{ $url }}" class="px-3 py-1 mx-1 bg-white text-gray-800 border border-gray-300 rounded hover:bg-gray-100">
                                                {{ $page }}
                                            </a>
                                        @endif
                                    @endforeach
